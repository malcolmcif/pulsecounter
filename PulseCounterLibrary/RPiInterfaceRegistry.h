...
class RPiInterfaceRegistry
{
public:
	//
	// Description: get the version available for the compiled architecture.
	//
	static RPiInterface& get();
	static void createEmulatedOnly();

private:
	static std::auto_ptr<RPiInterface> m_interface;
	static bool m_emulated;
};
